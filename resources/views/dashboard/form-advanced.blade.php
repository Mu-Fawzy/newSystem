...
<link href="{{URL::asset('assets/dashboard/assets/plugins/fancyuploder/fancy_fileupload.css')}}" rel="stylesheet" />
<!--Internal Sumoselect css-->
@if ( Config::get('app.locale') == 'ar')
	<link rel="stylesheet" href="{{URL::asset('assets/dashboard/assets/plugins/sumoselect/sumoselect-rtl.css')}}">
@else
	<link rel="stylesheet" href="{{URL::asset('assets/dashboard/assets/plugins/sumoselect/sumoselect.css')}}">
@endif

<!--Internal  TelephoneInput css-->
@if ( Config::get('app.locale') == 'ar')
	<link rel="stylesheet" href="{{URL::asset('assets/dashboard/assets/plugins/telephoneinput/telephoneinput-rtl.css')}}">
@else
	<link rel="stylesheet" href="{{URL::asset('assets/dashboard/assets/plugins/telephoneinput/telephoneinput.css')}}">
@endif
						...
						<div class="card">
							<div class="card-body">
								<div>
									...
									<p class="text-muted card-sub-title">A JavaScript plugin for entering and validating international telephone numbers. It adds a flag dropdown to any input, detects the users country, displays a relevant placeholder and provides formatting/validation methods.</p>
								</div>
							...
							<div class="card-body">
								...
								<div class="row mb-4">
									...
									<div class="col-sm-12 col-md-4 mg-t-10 mg-sm-t-0">
										<input type="file" class="dropify" data-default-file="{{URL::asset('assets/dashboard/assets/img/photos/1.jpg')}}" data-height="200"  />
									</div>
									<div class="col-sm-12 col-md-4 mg-t-10 mg-sm-t-0">
...
<script src="{{URL::asset('assets/dashboard/assets/plugins/fancyuploder/jquery.ui.widget.js')}}"></script>
<script src="{{URL::asset('assets/dashboard/assets/plugins/fancyuploder/jquery.fileupload.js')}}"></script>
<script src="{{URL::asset('assets/dashboard/assets/plugins/fancyuploder/jquery.iframe-transport.js')}}"></script>
<script src="{{URL::asset('assets/dashboard/assets/plugins/fancyuploder/jquery.fancy-fileupload.js')}}"></script>
<script src="{{URL::asset('assets/dashboard/assets/plugins/fancyuploder/fancy-uploader.js')}}"></script>
<!--Internal  Form-elements js-->
<script src="{{URL::asset('assets/dashboard/assets/js/advanced-form-elements.js')}}"></script>
<script src="{{URL::asset('assets/dashboard/assets/js/select2.js')}}"></script>
<!--Internal Sumoselect js-->
<script src="{{URL::asset('assets/dashboard/assets/plugins/sumoselect/jquery.sumoselect.js')}}"></script>
<!-- Internal TelephoneInput js-->
<script src="{{URL::asset('assets/dashboard/assets/plugins/telephoneinput/telephoneinput.js')}}"></script>
<script src="{{URL::asset('assets/dashboard/assets/plugins/telephoneinput/inttelephoneinput.js')}}"></script>
@endsection