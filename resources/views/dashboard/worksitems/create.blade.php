...
@section('title', __('content.create title',['model'=> removeLettersFromStart(trans_choice('content.work item',1) ,0 ,3) ]))
@section('css')
...
@section('page-header')
		...
		<div class="breadcrumb-header justify-content-between">
			<div class="my-auto">
				<div class="d-flex">
					<h4 class="content-title mb-0 my-auto">{{ trans_choice('content.work item',2) }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('content.create title',['model'=> removeLettersFromStart(trans_choice('content.work item',1) ,0 ,3) ]) }}</span>
				</div>
			</div>
		</div>
		<!-- breadcrumb -->
					...
					<div class="card">
						<div class="card-header pb-0">
							<div class="d-flex justify-content-between">
								<div>
									<h4 class="card-title mg-b-0 mb-2">{{ __('content.create title',['model'=> removeLettersFromStart(trans_choice('content.work item',1) ,0 ,3) ]) }}</h4>
								</div>
						...
						<div class="card-body">
							...
							<form class="form-horizontal" action="{{ route('workitems.store') }}" method="Post">
								@csrf
