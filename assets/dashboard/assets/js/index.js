$(function() {
	...
	var optionsBar = {
	 ...
	 colors: ["#22c03c", "#036fe7", '#f93a5a', '#f7a556'],
	 plotOptions: {
				bar: {
				  dataLabels: {
					enabled: false
	  ...
	  responsive: [{
	   ...
	   series: [{
		  name: jsonData.contracts_tran,
		  data: jsonData.contracts
	  }, {
		  name: jsonData.sites_tran,
		  data: jsonData.sites
	  }, {
		  name: jsonData.items_tran,
		  data: jsonData.items
	  },{
		  name: jsonData.subcontractors_tran,
		  data: jsonData.subcontractors
	  }],
